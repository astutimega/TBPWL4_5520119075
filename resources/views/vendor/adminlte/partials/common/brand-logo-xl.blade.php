...
<a href="{{ $dashboard_url }}"
    ...
    {{-- Small brand logo --}}
    <img src="{{ asset(config('adminlte.logo_img', 'vendor/adminlte/dist/img/mk.png')) }}"
         alt="{{ config('adminlte.logo_img_alt', 'MegSkin') }}"
         class="{{ config('adminlte.logo_img_class', 'brand-image-xl') }} logo-xs">

    {{-- Large brand logo --}}
    <img src="{{ asset(config('adminlte.logo_img_xl',  'vendor/adminlte/dist/img/mk.png'S)) }}"
         alt="{{ config('adminlte.logo_img_alt', 'MegSkin') }}"
